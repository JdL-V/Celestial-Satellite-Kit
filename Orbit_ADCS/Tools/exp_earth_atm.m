function [rho, rho0, zs, z0i] = exp_earth_atm(z)
    z0 = [0, 25, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120,...
    130, 140, 150, 180, 200, 250, 300, 350, 400, 450,...
    500, 600, 700, 800, 900, 1000]*1e3;
    ...
    rho0 = [1.225, 3.899e-2, 1.774e-2, 3.972e-3, 1.057e-3,...
    ...
    zs = [7.249, 6.349, 6.682, 7.554, 8.382, 7.714, 6.549,...
    ...
    181.05, 268.00]*M2*1e3;

    z0i = z0*M2;
    
    rho = rho0.*exp(-(z - z0i)./zs); 
end